...
def get_image(self):
    images = {
        ...
        "in_game": {"map": pygame.image.load("data/maps/map1.png").convert_alpha()},
        "menu_in_game": {"map": pygame.image.load("data/maps/map1.png").convert_alpha(), "alt_menu": pygame.image.load("data/img/black_screen.png").convert_alpha(), "save": pygame.image.load("data/icons/menu/save.png").convert(), "quit": pygame.image.load("data/icons/menu/quit.png").convert(), "quests": pygame.image.load("data/icons/menu/quests.png").convert(), "inventory": pygame.image.load("data/icons/menu/inventory.png").convert(), "equip": pygame.image.load("data/icons/menu/equip.png").convert()}
    }
    return images